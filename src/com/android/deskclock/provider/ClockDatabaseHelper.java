...
class ClockDatabaseHelper extends SQLiteOpenHelper {
    ...
    // This creates a default alarm at 5:30 for every Mon,Tue,Wed,Thu,Fri
    private static final String DEFAULT_ALARM_1 = "(5, 30, 31, 0, 0, '', NULL, 0, 0);";

    // This creates a default alarm at 7:00 for every Sat,Sun
    private static final String DEFAULT_ALARM_2 = "(7, 00, 96, 0, 0, '', NULL, 0, 0);";
